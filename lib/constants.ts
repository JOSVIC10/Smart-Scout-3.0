...
export const COMPETICIONES_BESOCCER: CompeticionConfig[] = [
  {
    ...
    grupos: [
      { slug: 'grupo1', nombre: 'Grupo 1 (Galicia)' },
      { slug: 'grupo2', nombre: 'Grupo 2 (Asturias)' },
      { slug: 'grupo3', nombre: 'Grupo 3 (Cantabria)' },
      { slug: 'grupo4', nombre: 'Grupo 4 (País Vasco)' },
      { slug: 'grupo5', nombre: 'Grupo 5 (Cataluña)' },
      { slug: 'grupo6', nombre: 'Grupo 6 (Comunidad Valenciana)' },
      { slug: 'grupo7', nombre: 'Grupo 7 (Comunidad de Madrid)' },
      { slug: 'grupo8', nombre: 'Grupo 8 (Castilla y León)' },
      { slug: 'grupo9', nombre: 'Grupo 9 (Andalucía Oriental y Melilla)' },
      { slug: 'grupo10', nombre: 'Grupo 10 (Andalucía Occidental y Ceuta)' },
      { slug: 'grupo11', nombre: 'Grupo 11 (Islas Baleares)' },
      { slug: 'grupo12', nombre: 'Grupo 12 (Islas Canarias)' },
      { slug: 'grupo13', nombre: 'Grupo 13 (Región de Murcia)' },
      { slug: 'grupo14', nombre: 'Grupo 14 (Extremadura)' },
      { slug: 'grupo15', nombre: 'Grupo 15 (Navarra)' },
      { slug: 'grupo16', nombre: 'Grupo 16 (La Rioja)' },
      { slug: 'grupo17', nombre: 'Grupo 17 (Aragón)' },
      { slug: 'grupo18', nombre: 'Grupo 18 (Castilla-La Mancha)' },
    ],
  },
  {
    ...
    grupos: [
      { slug: 'grupo1', nombre: 'Grupo 1 (Noroeste)' },
      { slug: 'grupo2', nombre: 'Grupo 2 (Norte / Valle del Ebro)' },
      { slug: 'grupo3', nombre: 'Grupo 3 (Cataluña / Levante / Baleares)' },
      { slug: 'grupo4', nombre: 'Grupo 4 (Andalucía / Murcia)' },
      { slug: 'grupo5', nombre: 'Grupo 5 (Centro / Canarias)' },
    ],
  },
]
